...
# Use customize XPATH
driver.find_element(AppiumBy.XPATH, '//android.widget.EditText[@text="First name"]').send_keys("Harry")
driver.hide_keyboard()
driver.find_element(AppiumBy.XPATH, '//android.widget.EditText[@text="Phone"]').send_keys("098765")
driver.find_element(AppiumBy.XPATH, '//*[contains(@text, "Save")]').click()
